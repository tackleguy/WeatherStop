...
const CATEGORIES: CategoryDef[] = [
  ...
  { key: 'special', label: 'Special', color: '#94a3b8' },
...
export function AlertFilterChips() {
  ...
  return (
    <div
      className="pointer-events-auto absolute left-4 top-3 z-10 flex max-w-[62vw] flex-wrap items-center gap-1.5 rounded-lg border border-[var(--line-default)] p-1.5 backdrop-blur-md"
    ...
    >
      ...
      <Link
        to="/outlooks"
        className="rounded-full px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-[var(--accent-2)] hover:bg-white/5"
      >
        SPC
      </Link>
    </div>
